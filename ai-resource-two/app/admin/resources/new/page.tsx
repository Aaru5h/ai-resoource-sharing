            ...
            <form style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
                ...
                <div>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "0.5rem" }}>
                        {TYPES.map(t => (
                            <button key={t.value} type="button" onClick={() => setSelectedType(t.value)} style={{
                                display: "flex", flexDirection: "column", alignItems: "center", gap: 6,
                                padding: "1rem 0.5rem", borderRadius: 10,
                                border: selectedType === t.value ? "1px solid var(--primary)" : "1px solid var(--border)",
                                background: selectedType === t.value ? "rgba(0,112,243,0.06)" : "var(--muted)",
                ...
                <div>
                    ...
                    <div style={{
                        ...
                        <Upload size={24} style={{ color: "var(--muted-foreground)", margin: "0 auto 0.75rem" }} />
                ...
                <div style={{
                    ...
                    padding: "1rem 1.25rem", borderRadius: 10, background: "var(--muted)",
                    ...
                    <label style={{
                        ...
                        <span style={{
                            position: "absolute", inset: 0, background: "var(--border)", borderRadius: 12,
                            transition: "0.2s",
                        }} />
                    </label>
                </div>
